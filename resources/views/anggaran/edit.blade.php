...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3 class="fw-bold m-0"><i class="bi bi-pencil-square"></i> Edit Anggaran</h3>
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-warning text-dark fw-semibold">
                <i class="bi bi-pencil me-2"></i> Form Edit Data Anggaran
            </div>
                ...
                <form action="{{ route('anggaran.update', $data->id) }}" method="POST">
                        ...
                        <div class="d-flex gap-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenisPemasukan"
                                    value="pemasukan"
                                    {{ old('jenis', $data->jenis) == 'pemasukan' ? 'checked' : '' }}
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenisPengeluaran"
                                    value="pengeluaran"
                                    {{ old('jenis', $data->jenis) == 'pengeluaran' ? 'checked' : '' }}
                                    onchange="toggleJenisPengeluaran(this.value)">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="sumber_dana" id="sumber_dana"
                            ...
                            value="{{ old('sumber_dana', $data->sumber_dana) }}" maxlength="200">
                    ...
                    <div class="mb-3" id="jenisPengeluaranWrapper"
                        style="{{ old('jenis', $data->jenis) == 'pengeluaran' ? '' : 'display:none' }}">
                        ...
                        <input type="text" name="jenis_pengeluaran" id="jenis_pengeluaran"
                            ...
                            value="{{ old('jenis_pengeluaran', $data->jenis_pengeluaran) }}" maxlength="100">
